  ...
  <body>
            ...
            <form action="carbooking_process.php" , method="POST">
              ...
              <div class="row mt-4">
                <div class="text-center col-12">
                  <button class="btn-login">Book</button>
                </div>
              </div>
            </form>
          </div>
    ...
    <section class="footer">
      <div class="container">
        ...
        <div class="row">
          <div
            class="col-lg-6 col-md-12 col-xl-6 col-xxl-6 col-sm-12 text-secondary row d-flex align-self-end"
          >
            <p>all @copyright reserved to Romaxdev</p>
          </div>
          <div
            class="col-lg-6 col-md-12 col-xl-6 col-xxl-6 col-sm-12 text-secondary text-end"
          >
            <p>
              made by
              <a
                class="text-capitalize text-decoration-none"
                href="https://www.facebook.com/rownokmahbub/"
                >Mehbubur Rahman Rownok</a
              >
            </p>
          </div>
        </div>
